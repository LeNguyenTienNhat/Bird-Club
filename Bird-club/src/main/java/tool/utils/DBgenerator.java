...
public class DBgenerator {
    ...
    public void generateUser() throws IOException {
        ...
        Tools tool = new Tools();
        String[] fullnameList = db.getArrayOfLine("D:\\gt\\Bird-Club\\Bird-club\\fullName.txt");
        String[] usernameList = db.getArrayOfLine("D:\\gt\\Bird-Club\\Bird-club\\username.txt");
        byte[] profilePicture = db.ImageToByteArray();
        for (int i = 0; i < 50; i++) {
            Member m = new Member();
            m.setUID("UID" + i);
