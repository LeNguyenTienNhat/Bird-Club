                                        ...
                                        <div class="row">
                                            <div class="tribe-events-event-image" style="width:300px; height: 300px;">
                                                ...
                                                <a href="${pageContext.request.contextPath}/TparticipationController?action=view&TID=${t.getTID()}&UID=${users.getUID()}" tabindex="-1">
                                                    <img width="300" height="300" src="${t.getPictureURL()}" class="attachment-medium size-medium wp-post-image" alt="${t.getPictureURL()}" srcset="${t.getPictureURL()} 300w,${t.getPictureURL()}  150w,${t.getPictureURL()}  600w" sizes="(max-width: 300px) 100vw, 300px">
                                                </a>
                                            </div>
