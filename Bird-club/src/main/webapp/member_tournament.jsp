...
<html class="no-js" lang="en-US">
    ...
    <a href="member_tournament.jsp"></a>
                            ...
                            <div id="post-3946" class="type-tribe_events post-3946 tribe-clearfix tribe-events-category-meetings tribe-events-organizer-873" style="margin-top: 20px; margin-bottom: 20px;">
                                ...
                                <div class="tribe-events-event-meta" style="margin-bottom:10px;">
                                    <div class="author location">
                                        <div class="tribe-event-schedule-details">
                                            <span class="tribe-event-date-start"><em><strong>${t.getStartDate()}</strong></em></span> <em>to</em> <span class="tribe-event-time"><em><strong>${t.getEndDate()}</strong></em></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="tribe-events-event-image" style="width:300px; height: 300px;">
                                        <c:choose>
                                            <c:when test="${t.image != null}">
                                                <a href="${pageContext.request.contextPath}/TparticipationController?action=view&TID=${t.getTID()}&UID=${users.getUID()}" tabindex="-1">
                                                    <img width="300" height="300" src="data:image/jsp;base64,${Base64.getEncoder().encodeToString(t.getImage())}" class="attachment-medium size-medium wp-post-image" alt="data:image/jsp;base64,${Base64.getEncoder().encodeToString(t.getImage())}" srcset="data:image/jsp;base64,${Base64.getEncoder().encodeToString(t.getImage())} 300w,data:image/jsp;base64,${Base64.getEncoder().encodeToString(t.getImage())} 150w,data:image/jsp;base64,${Base64.getEncoder().encodeToString(t.getImage())} 600w" sizes="(max-width: 300px) 100vw, 300px">
                                                </a>
                                            </c:when>
                                            <c:otherwise>
                                                <img width="300" height="300" src="${pageContext.request.contextPath}/path/to/placeholder/image.jpg" class="attachment-medium size-medium wp-post-image" alt="No Image Available">
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <div class="tribe-events-list-event-description col-md-6 tribe-events-content description entry-summary">
                                        ...
                                        <a href="${pageContext.request.contextPath}/TparticipationController?action=view&TID=${t.getTID()}&UID=${users.getUID()}" class="tribe-events-read-more" rel="bookmark">Find out more »</a>
                                    </div>
                                </div>
                                <hr>
                            </div>
