<%-- 
    Document   : member_forum
    Created on : Jun 4, 2023, 2:41:39 PM
    Author     : Tue
--%>
            ...
            <main id="main-content">
                ...
                <div class="content-container archive page-wider">
                    <header class="article-header" aria-label="Title">
                        <h1 id="archive-header" class="page-title">Community's shares</h1>
                        ...
                        <div class="wp-block-columns">
                            <div class="wp-block-column archive-content">
                                <div class="article-list list-style archives">
                                    ...
                                    <div class="is-layout-flow wp-block-group alignfull living-bird">
                                                    ...
                                                    <ul>
                                                        <li class="article-item">
                                                            <div class="article-item-container">
                                                                <div class="article-item-media content-article" data-link-to="https://www.birds.cornell.edu/home/a-modest-proposal-can-ebird-help-choose-better-state-birds-part-1/">
                                                                    <div class="article-item-media-ratio">
                                                                        <img src="https://th.bing.com/th/id/R.f05aabc1e73e7ad77e040457749e177e?rik=fCj2m8Q1J6rlWQ&riu=http%3a%2f%2fblog.hankchristensen.com%2fwp-content%2fuploads%2f2015%2f11%2fred-whiskered-bulbul-112491-Edit.jpg&ehk=lAdTjbz6c4N4zmrQq5nt0yp%2fxnsornvhHIXuBkgICsQ%3d&risl=&pid=ImgRaw&r=0" sizes="(min-width: 480px) 100vw, 480px">
                                                                    </div></div>
                                                                <div class="article-item-body">
                                                                    <a class="article-item-link" href=""><span class="article-item-header">Why red-whiskered bulbul is popular in Vietnam? </span></a></div></div>
                                                        </li>
